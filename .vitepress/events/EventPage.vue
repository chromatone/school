...
.flex.flex-col.p-4.m-2.rounded-xl.max-w-45ch.gap-4.bg-light-900(v-else)
  .flex.items-center
...
form.flex.flex-col.gap-2.m-2.bg-dark-50.bg-op-20.p-2.rounded-lg(@submit.prevent="participate()" v-if="!participating[hash] && isFuture(event?.date)")
